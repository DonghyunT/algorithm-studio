...
|---|---|
| 현재 운영 브랜치 | main |
| 현재 작업 브랜치 | codex/cbt-ui-polish-round2 (CBT 2차 UI/UX 고도화: 지필 2단 분할·슬림 레일·캔버스 섬 밀봉 및 엣지 케이스 안전 강화) |
| 인수인계 전달 기준 | 최신 main(3829d56) 기반 CBT 2차 UI/UX 고도화 구현 및 단위 테스트 72개 통과(통과율 100%) |
...
| 배포 기록 | Vercel Production 배포 대기 (main 병합 후 자동 배포 예정) |
