...
| 구분 | 인수인계 기준 |
|---|---|
| 운영 기준 | `main` · V4 단답형 정정 PR #9 merge `a7facd9`, 운영 은행 교체·DB 정정 완료 |
| 현재 작업 | `codex/remove-personal-report`: 개인 자기점검 보고서 중복 2개와 일회성 `diff.txt` 제거, 재등록·배포 제외 설정. 2026-09-24 main 병합·배포 승인, 반영 결과는 배포 기록 참조 |
