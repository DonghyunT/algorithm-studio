...
다른 PC 환경이나 새로운 AI 어시스턴트로 작업을 이어갈 때는 Git 원격 저장소의 `현재 운영 브랜치` 최신 커밋을 기준으로 상태를 동기화하며, AI에게 3대 핵심 문서(AGENTS, INTENT, PRD) 정독을 요청하여 컨텍스트를 즉시 복원합니다. 비밀 키는 인수인계 문서나 저장소에 남기지 않습니다.
