const EVAL_QUESTION_BANK = {
  ...
  "part2": [
    ...
    },
    {
      ...
      "difficultyScore": 5,
      "title": "선풍기 자동 가동 조건",
      "desc": "조건: [현재 실내 온도 >= 26℃] 일 때 참(Yes)이면 '켜기', 거짓(No)이면 '끄기'를 출력합니다.\n\n현재 실내 온도가 24℃일 때 출력 결과를 두 글자로 쓰시오.",
      "placeholder": "정답 입력",
      "answers": [
        "끄기",
        "꺼짐"
    ...
    },
    {
      ...
      "difficultyScore": 5,
      "title": "자동문 센서 감지",
      "desc": "조건: [사람이 감지되었는가?] 참(Yes)이면 '열림', 거짓(No)이면 '닫힘'을 실행합니다.\n\n문 앞 센서에 사람이 감지되었을 때 동작 결과를 두 글자로 쓰시오.",
      "placeholder": "정답 입력",
      "answers": [
        "열림",
        "열리기"
    ...
    },
    {
      ...
      "desc": "조건: [수하물 무게 < 10kg] 일 때 참(Yes)이면 '통과', 거짓(No)이면 '초과'를 출력합니다.\n\n측정된 수하물 무게가 정확히 10kg일 때 출력 결과를 두 글자로 쓰시오.",
      "placeholder": "정답 입력",
      "answers": [
        "초과",
        "불통과"
    ...
    },
    {
      ...
      "desc": "조건: [주행 속도 > 60km/h] 일 때 참(Yes)이면 '단속', 거짓(No)이면 '정상'을 출력합니다.\n\n자동차의 현재 속도가 정확히 60km/h일 때 출력 결과를 두 글자로 쓰시오.",
      "placeholder": "정답 입력",
      "answers": [
        "정상",
        "통과"
    ...
    },
    {
      ...
      "difficultyScore": 5,
      "title": "비밀번호 일치 여부 확인",
      "desc": "조건: [입력된 비밀번호 == 저장된 비밀번호] 일 때 참(Yes)이면 '성공', 거짓(No)이면 '실패'를 출력합니다.\n\n올바른 비밀번호를 입력했을 때 나타날 결과를 두 글자로 쓰시오.",
      "placeholder": "정답 입력",
      "answers": [
        "성공",
        "통과"
    ...
    },
    {
      ...
      "difficultyScore": 5,
      "title": "놀이기구 신장 제한 이상",
      "desc": "조건: [탑승객의 키 >= 150cm] 일 때 참(Yes)이면 '탑승', 거짓(No)이면 '불가'를 출력합니다.\n\n키가 정확히 150cm인 학생이 판정받을 결과를 두 글자로 쓰시오.",
      "placeholder": "정답 입력",
      "answers": [
        "탑승",
        "가능"
